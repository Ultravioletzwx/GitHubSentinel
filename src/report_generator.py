...
class ReportGenerator:
    ...
    def generate_daily_report(self, markdown_file_path,source_type='github'):
        # 读取Markdown文件并使用LLM生成日报
        with open(markdown_file_path, 'r') as file:
            markdown_content = file.read()

        report = self.llm.generate_daily_report(markdown_content,source_type=source_type)  # 调用LLM生成报告
